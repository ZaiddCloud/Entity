...
<template>
  <div class="p-8 font-arabic">
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-xl font-bold text-gray-800 underline decoration-blue-200 decoration-4">
    ...
    <div class="space-y-4">
      <div
        ...
        :key="segment.id"
        class="p-4 bg-gray-50 border border-gray-200 rounded-xl hover:shadow-md transition-shadow"
      >
        <div class="flex items-center gap-4 mb-3">
          <input
            ...
            type="text"
            placeholder="البداية"
            class="w-20 px-2 py-1 border rounded text-center font-mono text-sm"
          >
          <span>←</span>
          <input
          ...
          <input
            ...
            type="text"
            class="flex-1 px-3 py-1 border rounded font-bold"
    ...
    >
      <p class="text-gray-400">
        لا توجد مقاطع مضافة بعد. ابدأ بإضافة أول مقطع!
      </p>
    </div>
  </div>
</template>
