        ...
        <template #header>
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="font-black text-2xl dark:text-white leading-tight text-emerald-600">اللغات والترجمة</h2>
                        <p class="text-xs text-gray-400 font-bold mt-1 uppercase tracking-widest">إدارة اللغات المتاحة للمحتوى الرقمي والمادي</p>
                    </div>
                </div>
            ...
            <Table>
                <template #head>
                    <TableHead>
                        ...
                        <TableHeaderCell align="center">الرمز الدولي</TableHeaderCell>
                ...
                <template #body>
                    <TableBody>
                        <TableRow v-for="lang in languages.data" :key="lang.id">
                            <TableCell>
                                <input type="checkbox" v-model="selectedIds" :value="lang.id" class="rounded border-gray-300 text-emerald-600 shadow-sm focus:ring-emerald-500 dark:bg-white/5 dark:border-white/10" />
                            </TableCell>
                            <TableCell>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="font-black text-gray-900 dark:text-white">{{ lang.name }}</div>
                            ...
                            <TableCell class="text-left">
                                <div class="flex items-center justify-end gap-2">
                                    <IconButton :href="route('languages.show', lang.id)" color="emerald" title="عرض">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                    </IconButton>
                                    <IconButton :href="route('languages.edit', lang.id)" color="blue" title="تعديل">
