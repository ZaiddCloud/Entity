      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-xs text-gray-400 font-bold mt-1 uppercase tracking-widest">
            إنشاء سجل جديد في قاعدة بيانات الناشرين
          </p>
        </div>
      </div>
    </template>
        ...
        <Card class="!p-8 overflow-visible relative">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-center w-full">
                <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 dark:hover:bg-white/5 dark:bg-black/20 hover:bg-gray-100 dark:border-white/10 dark:hover:border-emerald-500/50 transition-all group">
                  <div class="flex flex-col items-center justify-center pt-5 pb-6">
                    <svg
                      class="w-8 h-8 mb-4 text-gray-500 group-hover:text-emerald-500 transition-colors"
                      aria-hidden="true"
              ...
              <div
                v-if="form.logo"
                class="mt-2 text-xs font-bold text-emerald-500 flex items-center gap-2"
              >
                <svg
                  class="w-4 h-4"
                  fill="none"
