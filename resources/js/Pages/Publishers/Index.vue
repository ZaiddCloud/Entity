    ...
    <AuthenticatedLayout title="دور النشر">
        ...
        <div class="space-y-8">
            ...
            <Table>
                <template #head>
                    <TableHead>
                        <TableHeaderCell class="!px-4 w-12 text-center">
                            <input id="publishers-select-all" type="checkbox" v-model="allSelected" class="rounded border-gray-300 dark:border-white/10 dark:bg-black text-emerald-600 focus:ring-emerald-500" />
                        </TableHeaderCell>
                        <TableHeaderCell>اسم دار النشر</TableHeaderCell>
                        <TableHeaderCell class="text-center">المقـر</TableHeaderCell>
                ...
                <template #body>
                    <TableBody>
                        <TableRow v-for="publisher in publishers.data" :key="publisher.id">
                            <TableCell class="!px-4 text-center">
                                <input :id="'publisher-select-' + publisher.id" type="checkbox" :value="publisher.id" v-model="selectedIds" class="rounded border-gray-300 dark:border-white/10 dark:bg-black text-emerald-600 focus:ring-emerald-500" />
                            </TableCell>
                            <TableCell>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="font-black text-gray-900 dark:text-white">{{ publisher.name }}</div>
                            ...
                            <TableCell class="text-left">
                                <div class="flex items-center justify-end gap-2">
                                    <IconButton :href="route('publishers.show', publisher.id)" color="emerald" title="عرض التفاصيل">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                    </IconButton>
                                    <IconButton :href="route('publishers.edit', publisher.id)" color="blue" title="تعديل">
