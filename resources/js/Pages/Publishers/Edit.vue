            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-6">
                <div
                  ...
                  class="w-16 h-16 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 overflow-hidden flex-shrink-0"
                >
                  <img
                    :src="'/storage/' + publisher.logo_path"
                ...
                <div class="flex-1">
                  <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 dark:hover:bg-white/5 dark:bg-black/20 hover:bg-gray-100 dark:border-white/10 dark:hover:border-blue-500/50 transition-all group">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                      <svg
                        class="w-8 h-8 mb-4 text-gray-500 group-hover:text-blue-500 transition-colors"
                        aria-hidden="true"
              ...
              <div
                v-if="form.logo"
                class="mt-2 text-xs font-bold text-blue-500 flex items-center gap-2"
              >
                <svg
                  class="w-4 h-4"
                  fill="none"
