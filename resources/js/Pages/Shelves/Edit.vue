  ...
  <AuthenticatedLayout title="تعديل الرف">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-[10px] text-gray-400 font-bold mt-1 uppercase tracking-widest">
            تحديث بيانات الموقع: {{ shelf.location_code }}
          </p>
        </div>
      </div>
    </template>
    ...
    <div class="max-w-4xl mx-auto">
      <Card>
        <form
          class="space-y-8"
          @submit.prevent="form.put(route('shelves.update', shelf.id))"
        >
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-2">
              ...
              />
              <p
                v-if="form.errors.location_code"
            ...
            <div class="space-y-2">
              <InputLabel
                for="capacity"
                value="السعة الاستيعابية (عدد النسخ)"
              />
              <TextInput
                id="capacity"
