                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-white/5">
                            <tr v-for="shelf in shelves.data" :key="shelf.id" class="group hover:bg-gray-50/50 dark:hover:bg-white/2 transition-colors">
                                <td class="px-8 py-6 whitespace-nowrap">
                                    <input type="checkbox" :value="shelf.id" v-model="selectedIds" class="rounded-lg border-gray-300 dark:border-white/10 dark:bg-black text-indigo-600 shadow-sm focus:ring-indigo-500" />
                                </td>
                                <td class="px-8 py-6 whitespace-nowrap">
