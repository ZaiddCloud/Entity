                ...
                <Card class="!p-8">
                     <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="mb-8 border-b border-gray-100 dark:border-white/5 pb-4">
                            ...
                            <p class="text-sm text-gray-500">تحديث معلومات الملف المرئي</p>
                        </div>

                        <!-- Title -->
                        <div>
                            <InputLabel for="title">عنوان المرئية</InputLabel>
                            <TextInput
                                id="title"
                                v-model="form.title"
                                type="text"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <InputLabel for="authors">المؤلفون / المقدمون</InputLabel>
                            ...
                            <!-- Publisher -->
                            <div class="md:col-span-2">
                                <InputLabel for="publisher">مركز الإنتاج / القناة</InputLabel>
                                <SelectInput
                                    id="publisher"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel for="duration" :optional="true">المدة (بالثواني)</InputLabel>
                                <TextInput
                                    id="duration"
                            ...
                            <div>
                                <InputLabel for="published_year" :optional="true">سنة الإنتاج</InputLabel>
                                <TextInput
                                    id="published_year"
                        ...
                        <!-- Description -->
                        <div>
                            <InputLabel for="description" :optional="true">الوصف</InputLabel>
                            <textarea
                                id="description"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100 dark:border-white/5">
                            ...
                            <div>
                                <InputLabel for="file" :optional="true">تحديث ملف الفيديو</InputLabel>
                                <div class="mt-1 flex items-center justify-center w-full">
                                    <label for="file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-700 border-dashed rounded-2xl cursor-pointer bg-gray-50 dark:bg-white/5 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 transition-colors">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            <svg class="w-8 h-8 mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-bold">اضغط للرفع</span></p>
                                        </div>
                                        <input id="file" type="file" @input="form.file = $event.target.files[0]" accept="video/*" class="hidden" />
                                    </label>
                                </div>
                                ...
                                <!-- Current File -->
                                <div v-if="video.file_path || video.versions?.[0]?.file_path" class="mt-3 p-3 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5 flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <svg class="w-5 h-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                                    ...
                                    <a :href="'/storage/' + (video.file_path || video.versions?.[0]?.file_path)" target="_blank" class="text-xs font-bold text-emerald-600 hover:text-emerald-500 bg-emerald-50 dark:bg-emerald-500/10 px-3 py-1.5 rounded-lg transition-colors">
                                        تحميل
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100 dark:border-white/5">
                            <Link :href="route('videos.show', video.slug)" class="text-sm font-bold text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white transition-colors">
                                إلغاء
                            </Link>
