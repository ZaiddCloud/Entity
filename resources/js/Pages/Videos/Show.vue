        ...
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    <span class="text-gray-400 dark:text-gray-500 ml-2 italic">{{ video.formatted_serial_number }}</span>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <div v-if="video.cover_path" class="mb-6">
                                ...
                                <div class="mb-8">
                                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">تحرير المحتوى (Scenes)</h3>
                                    <Link 
                                        v-if="first_content_slug"
                                        :href="`/editor/video/${first_content_slug}`"
                                    ...
                                    >
                                        ...
                                        <div class="text-right">
                                            ...
                                            <div class="text-[10px] opacity-80 font-bold">تحرير المشاهد والوصف (MongoDB)</div>
                                        </div>
                                    </Link>
                                </div>
