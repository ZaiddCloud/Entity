                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                ...
                                />
                                <div v-if="form.errors.order_column" class="mt-2 text-sm text-red-600">{{ form.errors.order_column }}</div>
                            </div>

                            <div class="flex items-center justify-end">
                                <Link :href="route('series.index')" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 underline decoration-none mr-4">
                                    إلغاء
                                </Link>
                                <button
                                    type="submit"
