                        ...
                        <div class="mb-8">
                            ...
                            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                <div class="sm:col-span-1">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ series.title }}</dd>
                                </div>
                                <div class="sm:col-span-1">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">الترتيب</dt>
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ series.order_column }}</dd>
                                </div>
                                <div class="sm:col-span-2">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">الوصف</dt>
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ series.description || 'لا يوجد وصف' }}</dd>
                                </div>
                            </dl>
                        </div>
