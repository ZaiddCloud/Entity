    ...
    <AuthenticatedLayout title="إضافة مؤلف جديد">
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="font-black text-2xl dark:text-white leading-tight">إضافة مؤلف جديد</h2>
                    <p class="text-xs text-gray-400 font-bold mt-1">إضافة سجل جديد لمؤلف أو عالم إلى قاعدة البيانات</p>
                </div>
            </div>
        </template>
