            ...
            <div class="flex-1 text-center md:text-right pb-4">
              ...
              <div class="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-6">
                ...
                <span
                  ...
                  class="px-4 py-1.5 rounded-full bg-rose-950/30 border border-rose-500/30 text-rose-200 text-xs font-bold backdrop-blur-sm"
                >
                  توفى عام {{ author.death_year }} هـ
                </span>
                <span
                  v-else
                  class="px-4 py-1.5 rounded-full bg-lime-950/30 border border-lime-500/30 text-lime-400 text-xs font-bold backdrop-blur-sm animate-pulse"
                >
                  على قيد الحياة
                </span>
              </div>
      ...
      >
        <div class="flex flex-col items-center justify-center py-20 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] border-2 border-dashed border-gray-200 dark:border-white/10">
          ...
          <p class="text-gray-500 font-bold">
            قائمة الإنتاج العلمي ستكون متاحة قريباً
          </p>
          <p class="text-xs text-gray-400 mt-2">
            يتم العمل على تجهيز عرض تفصيلي لكافة أعمال المؤلف
          </p>
        </div>
      </div>
    </div>
