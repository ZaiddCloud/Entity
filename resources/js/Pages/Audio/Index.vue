    ...
    <AuthenticatedLayout title="الصوتيات">
        ...
        <div class="space-y-6">
            ...
            <Table :pagination="audios.links">
                ...
                <template #body>
                    <TableBody>
                        <TableRow v-for="audio in audios.data" :key="audio.id" class="group hover:bg-emerald-50/5 dark:hover:bg-emerald-900/10">
                            ...
                            <TableCell>
                                <div class="font-bold text-gray-900 dark:text-white mb-1">{{ audio.title }}</div>
                                <div class="flex flex-wrap gap-1">
                                    <Badge v-for="tag in audio.tags" :key="tag.id" color="gray" size="sm">#{{ tag.name }}</Badge>
                                </div>
                            </TableCell>
                            ...
                            <TableCell>
                                <Badge color="emerald" v-if="audio.versions?.[0]?.publisher?.name">
