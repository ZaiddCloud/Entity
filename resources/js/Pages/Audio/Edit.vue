                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                <label for="authors" class="block text-sm font-medium text-gray-700 dark:text-gray-300">المؤلفون / القراء</label>
                                <select
                                    id="authors"
                                    name="author_ids[]"
                                    multiple
                            ...
                            <!-- Publisher -->
                            <div>
                                <label for="publisher" class="block text-sm font-medium text-gray-700 dark:text-gray-300">الناشر / المنتج</label>
                                <select
                                    id="publisher"
                                    name="publisher_id"
                                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="published_year" class="block text-sm font-medium text-gray-700 dark:text-gray-300">سنة الإصدار</label>
                                    <input
                                        id="published_year"
                                        name="published_year"
                                        type="number"
                            ...
                            <div>
                                <label for="file" class="block text-sm font-medium text-gray-700 dark:text-gray-300">تحديث الملف الصوتي (اختياري)</label>
                                <input
                                    id="file"
                                    name="file"
                                    type="file"
                            ...
                            <div class="flex items-center justify-end">
                                <Link :href="route('audios.show', audio.slug)" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 underline decoration-none mr-4">
                                    إلغاء
                                </Link>
                                <button
                                    type="submit"
