    ...
    <AuthenticatedLayout title="إضافة ملاحظة">
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="font-black text-2xl dark:text-white leading-tight text-emerald-600">إضافة ملاحظة جديدة</h2>
                    <p class="text-[10px] text-gray-400 font-bold mt-1 uppercase tracking-widest">تدوين الملاحظات والفوائد العلمية والأفكار</p>
                </div>
            </div>
        </template>
        ...
        <div class="max-w-4xl mx-auto py-8">
            <Card>
                <form @submit.prevent="form.post(route('notes.store'))" class="space-y-8">
                    <div class="space-y-2">
                        <InputLabel for="content" value="نص الملاحظة" />
                        <textarea
                            id="content"
