                ...
                <div class="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div class="flex items-center gap-6">
                        <div class="w-20 h-20 rounded-3xl bg-white/10 backdrop-blur-xl flex items-center justify-center text-4xl border border-white/20 shadow-inner">
                            <svg class="w-10 h-10 text-amber-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                        </div>
                        <div>
                            <div class="flex items-center gap-3 flex-wrap">
                                <h1 class="text-4xl font-black tracking-tight">عرض الملاحظة</h1>
                                <Badge color="amber" class="bg-amber-500/30 text-amber-100 border-amber-400/30">ملاحظة علمية</Badge>
                            </div>
                ...
                <div class="lg:col-span-2">
                    <Card class="h-full">
                        ...
                        <div class="text-gray-700 dark:text-gray-200 leading-relaxed text-lg italic bg-amber-50/30 dark:bg-amber-500/5 p-12 rounded-[3rem] border border-amber-100/50 dark:border-amber-500/10 shadow-inner relative">
                            ...
                            <div class="absolute top-8 right-8 text-amber-200/50 dark:text-amber-500/20 text-6xl font-serif">"</div>
                            <div class="relative z-10 whitespace-pre-wrap">
                                {{ note.content }}
                            </div>
                            <div class="absolute bottom-8 left-8 text-amber-200/50 dark:text-amber-500/20 text-6xl font-serif">"</div>
                        </div>
                    </Card>
                </div>
                ...
                <div class="lg:col-span-1">
                    <Card class="h-full">
                        ...
                        <dl class="space-y-6">
                            ...
                            <div>
                                <dt class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">آخر تحديث</dt>
                                <dd class="text-xs font-mono text-gray-400" dir="ltr">{{ new Date(note.updated_at).toLocaleString('ar-EG') }}</dd>
                            </div>
                        </dl>
                        <div class="mt-12 pt-12 border-t border-gray-100 dark:border-white/5">
                             <Link :href="route('notes.index')" class="text-xs font-black text-emerald-600 hover:text-emerald-500 transition-colors flex items-center gap-2">
