<template>
    <div class="min-h-screen flex items-center justify-center bg-[#0a0a0a] relative overflow-hidden font-sans text-[#EDEDEC]">
        ...
        <div class="relative z-10 w-full max-w-md p-8" dir="rtl">
            <!-- Glass Card -->
            <div class="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-8 transform transition-all hover:border-white/20">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div v-if="form.errors.email" class="text-red-400 text-xs mr-1">
                            {{ form.errors.email }}
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div v-if="form.errors.password" class="text-red-400 text-xs mr-1">
