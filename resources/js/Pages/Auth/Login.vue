<template>
  <div class="min-h-screen flex items-center justify-center bg-[#0a0a0a] relative overflow-hidden font-sans text-[#EDEDEC]">
    ...
    <div class="absolute inset-0 z-0">
      <div class="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-purple-900/20 rounded-full blur-[120px]" />
      <div class="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-blue-900/20 rounded-full blur-[120px]" />
    </div>
    ...
    >
      ...
      <div class="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-8 transform transition-all hover:border-white/20">
        ...
        >
          <!-- Email -->
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-300 mr-1">البريد الإلكتروني</label>
            <div class="relative group">
              <input 
                ...
                class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent transition-all group-hover:border-white/20 text-right"
                placeholder="name@example.com" 
              >
            </div>
            <div
              v-if="form.errors.email"
              class="text-red-400 text-xs mr-1"
            >
              {{ form.errors.email }}
            </div>
          </div>
          ...
          <!-- Password -->
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-300 mr-1">كلمة المرور</label>
            <div class="relative group">
              <input 
                id="password" 
