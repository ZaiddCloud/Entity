                ...
                <Card class="!p-8">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="mb-8 border-b border-gray-100 dark:border-white/5 pb-4">
                            <h3 class="text-lg font-black text-gray-900 dark:text-white">بيانات التسجيل</h3>
                            <p class="text-sm text-gray-500">أدخل معلومات الملف الصوتي الجديد</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Publisher -->
                            <div class="md:col-span-2">
                                <InputLabel for="publisher">الناشر / المنتج (اختياري)</InputLabel>
                                <SelectInput
                                    id="publisher"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100 dark:border-white/5">
                            ...
                            <div>
                                <InputLabel for="file">ملف الصوت (MP3, WAV)</InputLabel>
                                <div class="mt-1 flex items-center justify-center w-full">
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100 dark:border-white/5">
                            <Link :href="route('audios.index')" class="text-sm font-bold text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white transition-colors">
                                إلغاء
                            </Link>
