                ...
                <Card class="!p-8">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="mb-8 border-b border-gray-100 dark:border-white/5 pb-4">
                            ...
                            <p class="text-sm text-gray-500">تحديث معلومات التسجيل</p>
                        </div>
                        
                        <!-- Title -->
                        <div>
                            <InputLabel for="title">عنوان التسجيل</InputLabel>
                            <TextInput
                                id="title"
                                v-model="form.title"
                                type="text"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <InputLabel for="authors">المؤلف / القارئ</InputLabel>
                            ...
                            <!-- Publisher -->
                            <div class="md:col-span-2">
                                <InputLabel for="publisher">الناشر / المنتج</InputLabel>
                                <SelectInput
                                    id="publisher"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <InputLabel for="published_year" :optional="true">سنة الإصدار</InputLabel>
                                <TextInput
                                    id="published_year"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100 dark:border-white/5">
                            ...
                            <div>
                                <InputLabel for="file" :optional="true">تحديث ملف الصوت</InputLabel>
                                <div class="mt-1 flex items-center justify-center w-full">
                                    <label for="file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-700 border-dashed rounded-2xl cursor-pointer bg-gray-50 dark:bg-white/5 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 transition-colors">
                                        ...
                                        <input id="file" type="file" @input="form.file = $event.target.files[0]" accept="audio/*" class="hidden" />
                                    </label>
                                </div>
                                ...
                                <!-- Current File -->
                                <div v-if="audio.file_path || audio.versions?.[0]?.file_path" class="mt-3 p-3 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5 flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <svg class="w-5 h-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"></path></svg>
                                    ...
                                    <a :href="'/storage/' + (audio.file_path || audio.versions?.[0]?.file_path)" target="_blank" class="text-xs font-bold text-emerald-600 hover:text-emerald-500 bg-emerald-50 dark:bg-emerald-500/10 px-3 py-1.5 rounded-lg transition-colors">
                                        تحميل
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100 dark:border-white/5">
                            <Link :href="route('audios.show', audio.slug)" class="text-sm font-bold text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white transition-colors">
                                إلغاء
                            </Link>
