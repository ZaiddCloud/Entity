    ...
    <AuthenticatedLayout :title="'تعديل: ' + collection.name">
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="font-black text-2xl dark:text-white leading-tight text-blue-500">تعديل المجموعة: {{ collection.name }}</h2>
                    <p class="text-xs text-gray-400 font-bold mt-1 uppercase tracking-widest">تحديث بيانات القائمة المخصصة</p>
                </div>
            </div>
        </template>
