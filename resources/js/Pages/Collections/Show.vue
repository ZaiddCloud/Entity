          ...
          <div class="flex-1 text-center md:text-right pb-4">
            <div class="flex items-center justify-center md:justify-start gap-2 mb-2">
              <Badge
                ...
                class="!text-[10px] font-black uppercase tracking-wider backdrop-blur-sm"
              >
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card class="!p-6">
            <h4 class="font-black text-sm mb-4 text-blue-600 dark:text-blue-400 flex items-center justify-between">
              ...
              <Badge
                ...
                class="!text-[10px]"
              >
                {{ collection.audio.length }}
              </Badge>
            </h4>
            <ul class="space-y-3">
              <li
                v-for="item in collection.audio"
                :key="item.id"
                class="group"
              >
                <Link
          ...
          <Card class="!p-6">
            ...
            <ul class="space-y-3">
              <li
                v-for="item in collection.videos"
                :key="item.id"
                class="group"
              >
                <Link
          ...
          <Card class="!p-6">
            <h4 class="font-black text-sm mb-4 text-amber-600 dark:text-amber-400 flex items-center justify-between">
              ...
              <Badge
                ...
                class="!text-[10px]"
              >
                {{ collection.manuscripts.length }}
              </Badge>
            </h4>
            <ul class="space-y-3">
              <li
                v-for="item in collection.manuscripts"
                :key="item.id"
                class="group"
              >
                <Link
              ...
              <li
                v-if="!collection.manuscripts.length"
                class="text-xs text-gray-400 italic"
              >
                لا توجد مخطوطات
              </li>
