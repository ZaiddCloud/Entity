    ...
    <AuthenticatedLayout title="تفاصيل الحذف">
        ...
        <template #header>
            <div class="relative overflow-hidden bg-rose-700 rounded-[2.5rem] p-12 text-white shadow-2xl shadow-rose-900/40">
                ...
                <div class="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-rose-500/20 rounded-full blur-3xl"></div>
                <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-rose-400/10 rounded-full blur-3xl"></div>
                ...
                <div class="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div class="flex items-center gap-6">
                        <div class="w-20 h-20 rounded-3xl bg-white/10 backdrop-blur-xl flex items-center justify-center text-4xl border border-white/20 shadow-inner">
                            <svg class="w-10 h-10 text-rose-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                        </div>
                        <div>
                            <div class="flex items-center gap-3 flex-wrap">
                                <h1 class="text-4xl font-black tracking-tight">سجل عملية حذف</h1>
                                <Badge variant="danger" class="!px-4 !py-1 text-xs">عملية نهائية</Badge>
                            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <Card class="h-full">
                        ...
                        <dl class="space-y-6">
                            <div>
                                <dt class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">نوع الكيان</dt>
                                <dd class="text-base font-black text-gray-900 dark:text-white">{{ deletion.entity_type.split('\\').pop() }}</dd>
                            </div>
                            <div>
                                <dt class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">المعرف السابق (ID)</dt>
                                <dd class="text-sm font-mono text-gray-500 font-bold">{{ deletion.entity_id }}</dd>
                            </div>
                            <div>
                                <dt class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">سبب الحذف المصرح</dt>
                ...
                <div class="lg:col-span-2">
                    <Card class="h-full">
                        ...
                        <div v-if="deletion.data" class="overflow-hidden rounded-2xl border border-gray-100 dark:border-white/5">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-white/5">
                                <thead class="bg-gray-50 dark:bg-white/5">
                                    <tr>
                                        <th class="px-6 py-4 text-right text-[10px] font-black text-gray-400 uppercase tracking-widest">الحقل</th>
                                        <th class="px-6 py-4 text-right text-[10px] font-black text-gray-400 uppercase tracking-widest">القيمة المسترجعة</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-100 dark:divide-white/5 text-sm">
                                    <tr v-for="(val, key) in deletion.data" :key="key" class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                        ...
                        <div v-else class="flex flex-col items-center justify-center py-20 text-center opacity-40">
                            ...
                            <p class="text-sm font-black uppercase tracking-widest">لا توجد بيانات محفوظة لهذا الكيان</p>
                        </div>
                    </Card>
                </div>
            </div>
