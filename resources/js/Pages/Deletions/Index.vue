        ...
        <template #header>
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="font-black text-2xl dark:text-white leading-tight text-emerald-600">سجل المحذوفات</h2>
                        <p class="text-xs text-gray-400 font-bold mt-1 uppercase tracking-widest">تتبع الواردات الممسوحة وأسباب الحذف لضمان أمان البيانات</p>
                    </div>
                </div>
            </div>
        </template>
            ...
            <Table>
                <template #head>
                    <TableHead>
                        ...
                        <TableHeaderCell align="center">سبب الحذف</TableHeaderCell>
                        <TableHeaderCell align="left">التاريخ والوقت</TableHeaderCell>
                        <TableHeaderCell align="left">الإجراءات</TableHeaderCell>
                    </TableHead>
                </template>
                <template #body>
                    <TableBody>
                        <TableRow v-for="deletion in deletions.data" :key="deletion.id">
                            <TableCell>
                            ...
                            <TableCell align="center">
                                <div class="text-xs font-bold text-gray-500 dark:text-gray-400 italic max-w-xs truncate" :title="deletion.reason">
                            ...
                            <TableCell align="left">
                                <div class="flex items-center justify-end">
                                    <IconButton :href="route('deletions.show', deletion.id)" color="emerald" title="عرض التفاصيل">
