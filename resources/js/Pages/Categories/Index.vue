        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 font-bold mt-1 uppercase tracking-widest">
              تنظيم المحتوى الرقمي وتصنيفه بشكل شجري
            </p>
          </div>
        </div>
            ...
            >
              ...
              <TableCell>
                <Badge
                  ...
                  variant="gray"
                  class="!bg-gray-100 !text-gray-500 dark:!bg-white/5 dark:!text-gray-400"
                >
                  {{ category.parent.name }}
                </Badge>
                <span
                  v-else
                  class="text-gray-300 dark:text-gray-700 text-xs italic font-bold"
                >رئيسي</span>
              </TableCell>
              <TableCell>
                <div class="flex items-center gap-3">
