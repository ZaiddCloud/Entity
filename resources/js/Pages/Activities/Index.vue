        ...
        <template #header>
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="font-black text-2xl dark:text-white leading-tight text-emerald-600">سجل الرقابة</h2>
                        <p class="text-xs text-gray-400 font-bold mt-1 uppercase tracking-widest">تتبع كافة العمليات والتغييرات المنفذة في النظام</p>
                    </div>
                </div>
            </div>
        </template>
            ...
            <Table>
                <template #head>
                    <TableHead>
                        ...
                        <TableHeaderCell align="center">نوع العملية</TableHeaderCell>
                        <TableHeaderCell align="center">نوع المحتوى</TableHeaderCell>
                        <TableHeaderCell>الوصف</TableHeaderCell>
                        <TableHeaderCell align="left">التوقيت الزمنـي</TableHeaderCell>
                        ...
                        <TableRow v-for="activity in activities.data" :key="activity.id">
                            ...
                            <TableCell align="center">
                                <Badge 
                                    ...
                                    class="!px-3 !py-1"
                                >
                                    <span class="w-1.5 h-1.5 rounded-full bg-current ml-1"></span>
                                    {{ 
                            ...
                            <TableCell>
                                <span class="text-sm text-gray-700 dark:text-gray-300 font-bold truncate max-w-[300px] block" :title="activity.description">
                            ...
                            <TableCell align="left">
                                <div class="flex items-center justify-end">
                                    <IconButton :href="route('activities.show', activity.id)" color="emerald" title="عرض التفاصيل">
