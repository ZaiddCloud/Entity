    ...
    <AuthenticatedLayout title="المخطوطات">
        ...
        <div class="space-y-8">
            ...
            <Table>
                ...
                <TableBody>
                    <TableRow v-for="manuscript in manuscripts.data" :key="manuscript.id">
                        <TableCell>
                        ...
                        <TableCell>
                            <div class="font-black text-gray-900 dark:text-white">{{ manuscript.title }}</div>
                            <div class="flex gap-1 mt-1">
                                <Badge v-for="tag in manuscript.tags" :key="tag.id" color="gray" size="sm">
                                    #{{ tag.name }}
                                </Badge>
                            </div>
                        </TableCell>
                        <TableCell>
                            <span v-if="manuscript.authors && manuscript.authors.length" class="text-sm text-gray-600 dark:text-gray-400 font-bold">
                        ...
                        <TableCell class="text-left">
                            <div class="flex items-center justify-end gap-2">
                                <IconButton :href="route('manuscripts.show', manuscript.slug)" color="emerald" title="عرض التفاصيل">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                </IconButton>
                                <IconButton :href="route('manuscripts.edit', manuscript.slug)" color="blue" title="تعديل">
