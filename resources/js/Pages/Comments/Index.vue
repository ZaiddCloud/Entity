        ...
        <template #header>
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="font-black text-2xl dark:text-white leading-tight text-emerald-600">إدارة التعليقات</h2>
                        <p class="text-xs text-gray-400 font-bold mt-1 uppercase tracking-widest">مراجعة وتفاعل المستخدمين مع المحتوى الرقمي</p>
                    </div>
                </div>
                <Link
            ...
            <Table>
                <template #head>
                    <TableHead>
                        ...
                        <TableHeaderCell align="left">التوقيت</TableHeaderCell>
                        ...
                        <TableRow v-for="comment in comments.data" :key="comment.id">
                            ...
                            <TableCell align="left">
                                <div class="flex items-center justify-end gap-2">
                                    <IconButton :href="route('comments.show', comment.id)" color="emerald" title="عرض">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                    </IconButton>
                                    <IconButton :href="route('comments.edit', comment.id)" color="blue" title="تعديل">
