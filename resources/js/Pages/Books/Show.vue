    ...
    <AuthenticatedLayout :title="book.title">
        ...
        <div class="relative -mt-8 -mx-8 mb-8">
            ...
            <div class="absolute inset-0 h-[500px] overflow-hidden">
                <div class="absolute inset-0 bg-emerald-950/90 z-10"></div>
                <img 
                ...
                />
                <div v-else class="w-full h-full bg-gradient-to-br from-emerald-950 to-black"></div>
                <div class="absolute inset-0 bg-gradient-to-t from-gray-50 dark:from-[#050505] to-transparent z-20"></div>
            </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-10 items-start">
                        ...
                        <div class="group relative w-64 shrink-0 mx-auto md:mx-0 perspective-1000">
                             <div class="relative w-64 aspect-[2/3] rounded-xl shadow-2xl transition-transform duration-500 transform group-hover:rotate-y-6 group-hover:rotate-x-6 preserve-3d">
                                ...
                                >
                                <div v-else class="w-full h-full flex items-center justify-center bg-emerald-900 text-emerald-400 rounded-xl border border-lime-400/20">
                                    <span class="text-xs font-serif italic">No Cover</span>
                                </div>
                                
                                <!-- Shine Effect -->
                                <div class="absolute inset-0 bg-gradient-to-tr from-lime-400/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-xl pointer-events-none"></div>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 text-center md:text-right pt-4">
                            <div class="flex items-center justify-center md:justify-start gap-3 mb-6">
                                <Badge variant="gray" class="!bg-emerald-500/10 !text-lime-400 !border-lime-400/20 !text-xs !px-3 !py-1 backdrop-blur-md shadow-[0_0_10px_rgba(132,204,22,0.2)]">كتاب</Badge>
                            ...
                            <div class="flex flex-wrap items-center justify-center md:justify-start gap-6 text-emerald-100/70 mb-10 border-b border-emerald-500/10 pb-10">
                                <div class="flex items-center gap-2 group">
                                    <span class="p-1 rounded-full bg-emerald-500/10 group-hover:bg-lime-400/20 transition-colors">
                                        <svg class="h-4 w-4 text-lime-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                                    </span>
                                ...
                                <div class="flex items-center gap-2 group">
                                     <span class="p-1 rounded-full bg-emerald-500/10 group-hover:bg-lime-400/20 transition-colors">
                                        <svg class="h-4 w-4 text-lime-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                                    </span>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                ...
                                >
                                    <svg class="w-5 h-5 ml-2 text-emerald-900" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                                    بدء القراءة الآن
                                </Link>
                                ...
                                >
                                    <svg class="w-5 h-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                    تعديل
                                </Link>
                            </div>
                        </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-40">
            ...
            <div class="min-h-[400px]">
                ...
                <div v-if="activeTab === 'overview'" class="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in">
                    <div class="lg:col-span-2 space-y-8">
                        <Card>
                            <h3 class="text-lg font-black text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                                <svg class="w-5 h-5 text-lime-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                                نبذة عن الكتاب
                            </h3>
                            <div class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 leading-loose text-justify font-normal">
                                <p class="whitespace-pre-line">{{ book.description || 'لا يوجد وصف متاح لهذا الكتاب حالياً.' }}</p>
                            </div>
                        </Card>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Card class="bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-900/10 dark:to-transparent border-emerald-100 dark:border-emerald-500/10">
                                <h3 class="text-xs font-bold text-emerald-800 dark:text-emerald-400 uppercase tracking-widest mb-4">التصنيفات</h3>
                                <div class="flex flex-wrap gap-2">
                                    <Badge v-for="cat in book.categories" :key="cat.id" variant="success" class="!bg-white dark:!bg-emerald-500/20 !text-emerald-700 dark:!text-emerald-300 !border-emerald-200 dark:!border-emerald-500/20">{{ cat.name }}</Badge>
                                    <span v-if="!book.categories?.length" class="text-sm text-gray-400">غير مصنف</span>
                                </div>
                            </Card>
                            
                             <Card class="bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-900/10 dark:to-transparent border-emerald-100 dark:border-emerald-500/10">
                                <h3 class="text-xs font-bold text-emerald-800 dark:text-emerald-400 uppercase tracking-widest mb-4">الوسوم</h3>
                                <div class="flex flex-wrap gap-2">
                                    <span v-for="tag in book.tags" :key="tag.id" class="px-2 py-1 rounded-sm bg-white dark:bg-black/20 border border-emerald-100 dark:border-emerald-500/20 text-xs font-medium text-emerald-600 dark:text-emerald-400">
                                        #{{ tag.name }}
                                    </span>
                                    <span v-if="!book.tags?.length" class="text-sm text-gray-400">لا يوجد وسوم</span>
                                </div>
                            </Card>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <Card>
                            <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">ملفات التحميل</h3>
                            <a 
                            ...
                            >
                                ...
                                <svg class="w-4 h-4 text-emerald-300 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                            </a>
                ...
                <div v-if="activeTab === 'details'" class="animate-fade-in">
                    <Card>
                        <h3 class="text-lg font-black text-gray-900 dark:text-white mb-6">البيانات التقنية</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div class="p-4 rounded-lg bg-gray-50 dark:bg-emerald-900/5 border border-gray-100 dark:border-emerald-500/10">
                                <dt class="text-xs font-bold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mb-2">ISBN</dt>
                                <dd class="text-lg font-mono font-bold text-gray-800 dark:text-emerald-100">{{ book.versions?.[0]?.isbn || '-' }}</dd>
                            </div>
                            <div class="p-4 rounded-lg bg-gray-50 dark:bg-emerald-900/5 border border-gray-100 dark:border-emerald-500/10">
                                <dt class="text-xs font-bold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mb-2">الناشر</dt>
                                <dd class="text-lg font-bold text-gray-800 dark:text-emerald-100">{{ book.versions?.[0]?.publisher?.name || 'غير معروف' }}</dd>
                            </div>
                            <div class="p-4 rounded-lg bg-gray-50 dark:bg-emerald-900/5 border border-gray-100 dark:border-emerald-500/10">
                                <dt class="text-xs font-bold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mb-2">تاريخ الإضافة</dt>
                                <dd class="text-lg font-bold text-gray-800 dark:text-emerald-100">{{ new Date(book.created_at).toLocaleDateString('ar-EG') }}</dd>
                            </div>
                             <div class="p-4 rounded-lg bg-gray-50 dark:bg-emerald-900/5 border border-gray-100 dark:border-emerald-500/10">
                                <dt class="text-xs font-bold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mb-2">اخر تحديث</dt>
                                <dd class="text-lg font-bold text-gray-800 dark:text-emerald-100">{{ new Date(book.updated_at).toLocaleDateString('ar-EG') }}</dd>
                            </div>
                        </div>
                    </Card>
                </div>
                ...
                <div v-if="activeTab === 'reviews'" class="animate-fade-in">
                    <Card>
                         <div class="flex items-center justify-between mb-8">
                            <h3 class="text-lg font-black text-gray-900 dark:text-white">التعليقات والمناقشات</h3>
                            <Badge variant="success" class="!bg-emerald-100 dark:!bg-emerald-500/10 !text-emerald-800 dark:!text-emerald-300">{{ book.comments?.length || 0 }} تعليق</Badge>
                        </div>
                        
                        <div class="space-y-6">
                            <div v-for="comment in book.comments" :key="comment.id" class="flex gap-4 p-6 rounded-lg bg-emerald-50 dark:bg-emerald-900/5 border border-emerald-100 dark:border-emerald-500/10">
                            ...
                            <div v-if="!book.comments?.length" class="text-center py-12">
                                ...
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">لا توجد تعليقات حتى الآن</h3>
                                <p class="text-gray-500 text-sm">كن أول من يشارك برأيه حول هذا الكتاب</p>
                            </div>
                        </div>
                    </Card>
                </div>
