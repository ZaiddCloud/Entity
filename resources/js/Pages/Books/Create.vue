            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <form @submit.prevent="submit" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="cover" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">صورة الغلاف</label>
                            ...
                            <div>
                                <label for="file" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">ملف الكتاب (PDF) <span class="text-rose-500">*</span></label>
                                <input
                                    id="file"
                                    type="file"
                                    class="block w-full text-xs text-gray-500 file:mr-4 file:py-3 file:px-6 file:rounded-xl file:border-0 file:text-xs file:font-black file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 transition-all bg-gray-50 dark:bg-white/5 rounded-2xl p-2 cursor-pointer"
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6">
                            <Link :href="route('books.index')" class="text-sm font-bold text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                                إلغاء
                            </Link>
                            <PrimaryButton
                                type="submit"
